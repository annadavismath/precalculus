...
\begin{image}
   \includegraphics[height=3in]{160H2pic8.jpg}
 \end{image}
  \begin{enumerate}
\item
$(g\circ f)(2)=\answer{5}$
...
\begin{enumerate}
    \item \begin{image}
   \includegraphics[height=3in]{160H3pic4.jpg}
 \end{image}
 \begin{multipleChoice}  
...
\choice{$g(x)=f(x+2)$}  
  \end{multipleChoice}
   ...
   \item \begin{image}
   \includegraphics[height=3in]{160H3pic2.jpg}
 \end{image}
 \begin{multipleChoice}  
 \choice{$g(x)=-f(x)-1$}
\choice{$g(x)=-f(x-1)$} 
...
\choice[correct]{$g(x)=-f(x)+1$}
  ...
  \item \begin{image}
   \includegraphics[height=3in]{160H3pic3.jpg}
 \end{image}
 \begin{multipleChoice}  
 \choice{$g(x)=-f(x+1)-1$}
